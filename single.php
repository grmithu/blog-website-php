                        ...
                        <div class="col-md-12">
                            <?php
                                ...
                                <?php }
                                    ...
                                    echo '<a href="#login">Please Login to post your Comment</a>';
                                }
                            ?>  
                            ...
                            <?php
                                if ( isset($_POST['postComment']) ){
                                    ...
                                    $sql = "INSERT INTO comments (name, comments, post_id, status, c_date) VALUES ('$name', '$comments', '$post_id', '0', now())";
                        ...
                        <?php
                            ...
                            <?php
                                if ( isset($_POST['replyPostComment']) ){
                                    ...
                                    $sql = "INSERT INTO comments (r_id, name, comments, post_id, status, c_date) VALUES ('$r_id', '$name', '$comments', '$post_id', '1', now())";
